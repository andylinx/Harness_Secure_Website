# HarneSS — project website

A single-page, dependency-free project site for **HarneSS: Automatically Securing
Agents with Model- and Domain-Specific Safety Harnesses** (Li & Xiao, JHU).
...
| `assets/`    | `HarneSS_paper.pdf`, loop/shield icons (from the demo deck) |
