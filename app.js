/* ============================================================
   HarneSS project page — interactivity
...
const ROWS = [
  ["Claude 4.6 Sonnet", [
    ...
    ["HarneSS", 80.0,"0.0","0.0","0.0", 80.0,"1.4","0.0","2.9", 83.3,"1.4","2.9","0.0", true],
  ]],
  ["GLM-5", [
    ...
    ["HarneSS", 80.0,"11.4","17.1","5.7", 83.3,"10.0","8.6","11.4", 73.3,"2.9","5.7","0.0", true],
  ]],
  ["Kimi-2.5", [
    ...
    ["HarneSS", 70.0,"18.6","31.4","5.7", 83.3,"10.0","8.6","11.4", 80.0,"2.9","2.9","2.9", true],
  ]],
  ["qwen3.7-plus", [
    ...
    ["HarneSS", 70.0,"7.1","0.0","14.3", 93.3,"17.1","11.4","22.9", 73.3,"1.4","2.9","0.0", true],
  ]],
  ["DeepSeek V4 Flash", [
    ...
    ["HarneSS", 80.0,"44.3","74.3","14.3", 83.3,"20.0","20.0","20.0", 83.3,"1.4","2.9","0.0", true],
  ]],
];
